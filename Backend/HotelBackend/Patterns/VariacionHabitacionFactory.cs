namespace HotelBackend.Patterns
{
    ...
    {
        private const decimal PRECIO_BASE_SIMPLE = 150m;
        private const int CAPACIDAD_SIMPLE = 1;
        public static VariacionBase GetVariacion(string tipo)
        {
            return tipo.ToLower() switch
            {
                ...
                "simple" => new VariacionBase {
                     Nombre = "Simple", Capacidad = CAPACIDAD_SIMPLE, PrecioBase = PRECIO_BASE_SIMPLE 
                },
